...
<nav>
	<img alt="logo" class="icon" src={imageSrc} />
	...
	<ul>
		...
		<li class="about">
			<a sveltekit:prefetch href="/signup" class:selected={section === 'signup'}>signup</a>
		</li>
		<li><a sveltekit:prefetch href="/about" class:selected={section === 'about'}>about</a></li>
		<li><a sveltekit:prefetch href="/about" class:selected={section === 'about'}>about</a></li>
		<li><a sveltekit:prefetch href="/about" class:selected={section === 'about'}>about</a></li>
	</ul>
</nav>
